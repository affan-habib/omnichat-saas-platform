  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        whatsapp: "bg-brand-whatsapp text-white hover:bg-brand-whatsapp/90 shadow-sm",
        messenger: "bg-brand-messenger text-white hover:bg-brand-messenger/90 shadow-sm",
        instagram: "bg-brand-instagram text-white hover:bg-brand-instagram/90 shadow-sm",
      },
      size: {
